...
def show_encrypt_result():
    ...
    if not validate_key(key):
        messagebox.showerror("Input Error", "Key must be a 16-bit binary string.")
        return
...
# 创建主窗口
root = tk.Tk()
root.title("S-AES Encryption/Decryption Tool with ASCII Support")
